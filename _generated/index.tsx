              ...
              | {
                  ...
                  post?:
                    | {
                        ...
                        title: string;
                        content: string;
                        reacted?: Array<Reaction> | null | undefined;
                        ...
                        comments: Array<{
                          ...
                          author: {
                            ...
                            rankProgress?: number | null | undefined;
                            picture: {
                              __typename?: "Picture";
                              url?: string | null | undefined;
                            };
...
export type CreatePostCardMutationMutation = {
  __typename?: "Mutation";
  upsertPost?:
    | {
        __typename?: "UpsertPostPayload";
        postEdge?:
          | {
              __typename?: "PostEdge";
              node?: { __typename?: "Post"; id: string } | null | undefined;
            }
          | null
          | undefined;
      }
...
export const ClassesDocument = `
  ...
  classes {
    ...
    `;
export const useClassesQuery = <TData = ClassesQuery, TError = unknown>(
  client: GraphQLClient,
  ...
  useQuery<ClassesQuery, TError, TData>(
    ...
    fetcher<ClassesQuery, ClassesQueryVariables>(
      client,
      ClassesDocument,
      variables,
      headers
...
export const FeedDocument = `
  ...
  posts(team: $team, user: $user, first: 3) {
    edges {
      post: node {
        id
        title
...
>(
  ...
  options?: UseMutationOptions<
    CreatePostCardMutationMutation,
    TError,
    CreatePostCardMutationMutationVariables,
    TContext
  >,
  headers?: RequestInit["headers"]
) =>
  ...
  >(
    ...
    (variables?: CreatePostCardMutationMutationVariables) =>
      fetcher<
        CreatePostCardMutationMutation,
        CreatePostCardMutationMutationVariables
      >(client, CreatePostCardMutationDocument, variables, headers)(),
    options
  );
